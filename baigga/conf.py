...
BLOG_AUTHOR = "Crissky"  # (translatable)
BLOG_TITLE = "Baigga"  # (translatable)
...
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Um blog de videogames com um layout retrô."  # (translatable)
...
DEFAULT_PREVIEW_IMAGE = "/images/default-preview.jpg"

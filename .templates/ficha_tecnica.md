...
<div class="my-4 p-4 bg-light border-start border-primary border-4 rounded-end shadow-sm"
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
            ...
            <span class="text-success fw-bold" style="font-size: 1.1rem;">TEXTO-AQUI</span>
        </div>
    </div>
</div>
```
